...
{
    [TestClass]
    public class addsubTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task addsub_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/unsigned/addsub.cs
using System;
