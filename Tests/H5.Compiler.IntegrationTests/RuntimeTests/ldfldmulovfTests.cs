...
{
    [TestClass]
    public class ldfldmulovfTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task ldfldmulovf_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/unsigned/ldfld_mulovf.cs
using System;
