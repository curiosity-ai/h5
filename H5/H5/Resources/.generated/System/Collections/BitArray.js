    H5.define("System.Collections.BitArray", {
        ...
        statics: {
            ...
            methods: {
                GetArrayLength: function (n, div) {
                    return n > 0 ? ((((((H5.Int.div((((n - 1) | 0)), div)) | 0)) + 1) | 0)) : 0;
                }
            }
        },
        fields: {
        ...
        ctors: {
            ...
            $ctor1: function (bytes) {
                ...
                if (bytes.length > 268435455) {
                    throw new System.ArgumentException.$ctor3(System.String.format("The input array length must not exceed Int32.MaxValue / {0}. Otherwise BitArray.Length would exceed Int32.MaxValue.", [H5.box(System.Collections.BitArray.BitsPerByte, System.Int32)]), "bytes");
                }
                ...
                this.m_length = H5.Int.mul(bytes.length, System.Collections.BitArray.BitsPerByte);

                var i = 0;
                var j = 0;
                while (((bytes.length - j) | 0) >= 4) {
                    this.m_array[System.Array.index(H5.identity(i, ((i = (i + 1) | 0))), this.m_array)] = (bytes[System.Array.index(j, bytes)] & 255) | ((bytes[System.Array.index(((j + 1) | 0), bytes)] & 255) << 8) | ((bytes[System.Array.index(((j + 2) | 0), bytes)] & 255) << 16) | ((bytes[System.Array.index(((j + 3) | 0), bytes)] & 255) << 24);
                    j = (j + 4) | 0;
                }
            ...
            ctor: function (values) {
                ...
                for (var i = 0; i < values.length; i = (i + 1) | 0) {
                    if (values[System.Array.index(i, values)]) {
                        this.m_array[System.Array.index(($t = ((H5.Int.div(i, 32)) | 0)), this.m_array)] = this.m_array[System.Array.index($t, this.m_array)] | (1 << (i % 32));
                    }
                }
            ...
            $ctor5: function (values) {
                ...
                if (values.length > 67108863) {
                    throw new System.ArgumentException.$ctor3(System.String.format("The input array length must not exceed Int32.MaxValue / {0}. Otherwise BitArray.Length would exceed Int32.MaxValue.", [H5.box(System.Collections.BitArray.BitsPerInt32, System.Int32)]), "values");
                }

                this.m_array = System.Array.init(values.length, 0, System.Int32);
                this.m_length = H5.Int.mul(values.length, System.Collections.BitArray.BitsPerInt32);
        ...
        methods: {
            ...
            copyTo: function (array, index) {
                ...
                if (H5.is(array, System.Array.type(System.Int32))) {
                ...
                } else if (H5.is(array, System.Array.type(System.Byte))) {
                    ...
                    var b = H5.cast(array, System.Array.type(System.Byte));
                    for (var i = 0; i < arrayLength; i = (i + 1) | 0) {
                        b[System.Array.index(((index + i) | 0), b)] = ((this.m_array[System.Array.index(((H5.Int.div(i, 4)) | 0), this.m_array)] >> (H5.Int.mul((i % 4), 8))) & 255) & 255;
                    }
                } else if (H5.is(array, System.Array.type(System.Boolean))) {
                    if (((array.length - index) | 0) < this.m_length) {
                        throw new System.ArgumentException.$ctor1("Offset and length were out of bounds for the array or count is greater than the number of elements from index to the end of the source collection.");
                    }

                    var b1 = H5.cast(array, System.Array.type(System.Boolean));
                    for (var i1 = 0; i1 < this.m_length; i1 = (i1 + 1) | 0) {
                        b1[System.Array.index(((index + i1) | 0), b1)] = ((this.m_array[System.Array.index(((H5.Int.div(i1, 32)) | 0), this.m_array)] >> (i1 % 32)) & 1) !== 0;
                    }
                } else {
            ...
            Get: function (index) {
                ...
                return (this.m_array[System.Array.index(((H5.Int.div(index, 32)) | 0), this.m_array)] & (1 << (index % 32))) !== 0;
            },
            Set: function (index, value) {
                ...
                if (value) {
                    this.m_array[System.Array.index(($t = ((H5.Int.div(index, 32)) | 0)), this.m_array)] = this.m_array[System.Array.index($t, this.m_array)] | (1 << (index % 32));
                } else {
                    this.m_array[System.Array.index(($t1 = ((H5.Int.div(index, 32)) | 0)), this.m_array)] = this.m_array[System.Array.index($t1, this.m_array)] & (~(1 << (index % 32)));
                }
