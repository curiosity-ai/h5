...
{
    [TestClass]
    public class ngstandardTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task ngstandard_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/CoreMangLib/system/delegate/generics/ng_standard.cs
using System;
...
public class Program
{
    ...
    {
        try {
            return Test_ng_standard.TestEntryPoint();
        } catch(Exception e) {
