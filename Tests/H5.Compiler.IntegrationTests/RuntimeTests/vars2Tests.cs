...
{
    [TestClass]
    public class vars2Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task vars2_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Regression/CLR-x86-JIT/V2.0-Beta2/b268908/vars2.cs
using System;
...
public class Program
{
    ...
    {
        try {
            return Test_vars2.TestEntryPoint();
        } catch(Exception e) {
