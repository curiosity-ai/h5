    HighFive.define("System.Collections.Generic.Stack$1", function (T) { return {
        ...
        ctors: {
            ...
            $ctor1: function (collection) {
                ...
                var length = { };
                this._array = HighFive.Collections.EnumerableHelpers.ToArray$1(T, collection, length);
                this._size = length.v;
            }
        },
        methods: {
            ...
            CopyTo: function (array, arrayIndex) {
                ...
                if (!HighFive.referenceEquals(array, this._array)) {
                    var srcIndex = 0;
                    var dstIndex = (arrayIndex + this._size) | 0;
                    for (var i = 0; i < this._size; i = (i + 1) | 0) {
                        array[System.Array.index(((dstIndex = (dstIndex - 1) | 0)), array)] = this._array[System.Array.index(HighFive.identity(srcIndex, ((srcIndex = (srcIndex + 1) | 0))), this._array)];
                    }
                } else {
            ...
            Pop: function () {
                ...
                this._array[System.Array.index(this._size, this._array)] = HighFive.getDefaultValue(T);
                return item;
            },
            Push: function (item) {
                if (this._size === this._array.length) {
                    var localArray = { v : this._array };
                    System.Array.resize(localArray, (this._array.length === 0) ? System.Collections.Generic.Stack$1(T).DefaultCapacity : HighFive.Int.mul(2, this._array.length), function () {
                        return HighFive.getDefaultValue(T);
                    }, T);
                    this._array = localArray.v;
                }
                this._array[System.Array.index(HighFive.identity(this._size, ((this._size = (this._size + 1) | 0))), this._array)] = item;
                this._version = (this._version + 1) | 0;
            },
            ToArray: function () {
