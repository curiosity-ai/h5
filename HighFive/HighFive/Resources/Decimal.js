    ...
    HighFive.Class.addExtend(System.Decimal, [System.IComparable, System.IFormattable, System.IComparable$1(System.Decimal), System.IEquatable$1(System.Decimal)]);
    ...
    System.Decimal.getValue = function (d) {
        ...
        if (d instanceof System.Int64 || d instanceof System.UInt64) {
            return new HighFive.$Decimal(d.toString());
        }

        return new HighFive.$Decimal(d);
    };
    ...
    System.Decimal.prototype.toString = function (format, provider) {
        return HighFive.Int.format(this, format || "G", provider);
    };
    ...
    System.Decimal.prototype.format = function (format, provider) {
        return HighFive.Int.format(this, format, provider);
    };
    ...
    System.Decimal.round = function (obj, mode) {
        ...
        var old = HighFive.$Decimal.rounding;

        HighFive.$Decimal.rounding = mode;

        var d = new System.Decimal(obj.value.round());

        HighFive.$Decimal.rounding = old;
    ...
    System.Decimal.toInt = function (v, tp) {
        ...
        if (tp) {
            ...
            return HighFive.Int.check(HighFive.Int.trunc(v.value.toNumber()), tp);
        }

        var i = HighFive.Int.trunc(System.Decimal.getValue(v).toNumber());

        if (!HighFive.Int.$is(i)) {
            throw new System.OverflowException();
        }
    ...
    System.Decimal.setConfig = function (config) {
        HighFive.$Decimal.config(config);
    };
    ...
    System.Decimal.min = function () {
        ...
        d = HighFive.$Decimal.min.apply(HighFive.$Decimal, values);
    ...
    System.Decimal.max = function () {
        ...
        d = HighFive.$Decimal.max.apply(HighFive.$Decimal, values);
    ...
    System.Decimal.random = function (dp) {
        return new System.Decimal(HighFive.$Decimal.random(dp));
    };
    ...
    System.Decimal.prototype.toFormat = function (dp, rm, provider) {
        ...
        if (provider && !provider.getFormat) {
            config = HighFive.merge(config, provider);
    ...
    System.Decimal.fromBytes = function (bytes) {
        var value = new System.Decimal(0),
            s = HighFive.Int.sxb(bytes[0] & 255),
            e = bytes[1],
            ln = bytes[2],
            d = [];
    ...
    HighFive.$Decimal.config({ precision: 29 });
