...
{
    [TestClass]
    public class lcsmixedTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task lcsmixed_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Arrays/lcs/lcsmixed.cs
using System;
