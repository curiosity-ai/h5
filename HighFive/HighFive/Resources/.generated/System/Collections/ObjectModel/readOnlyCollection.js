    HighFive.define("System.Collections.ObjectModel.ReadOnlyCollection$1", function (T) { return {
        ...
        alias: [
            ...
            "System$Collections$Generic$IList$1$getItem", "System$Collections$Generic$IList$1$" + HighFive.getTypeAlias(T) + "$getItem",
            "System$Collections$Generic$IList$1$setItem", "System$Collections$Generic$IList$1$" + HighFive.getTypeAlias(T) + "$setItem",
            "System$Collections$Generic$ICollection$1$add", "System$Collections$Generic$ICollection$1$" + HighFive.getTypeAlias(T) + "$add",
            "System$Collections$Generic$ICollection$1$clear", "System$Collections$Generic$ICollection$1$" + HighFive.getTypeAlias(T) + "$clear",
            "System$Collections$Generic$IList$1$insert", "System$Collections$Generic$IList$1$" + HighFive.getTypeAlias(T) + "$insert",
            "System$Collections$Generic$ICollection$1$remove", "System$Collections$Generic$ICollection$1$" + HighFive.getTypeAlias(T) + "$remove",
            "System$Collections$Generic$IList$1$removeAt", "System$Collections$Generic$IList$1$" + HighFive.getTypeAlias(T) + "$removeAt"
        ],
        ctors: {
            ctor: function (list) {
                this.$initialize();
        ...
        methods: {
            ...
            System$Collections$IList$contains: function (value) {
                if (System.Collections.ObjectModel.ReadOnlyCollection$1(T).IsCompatibleObject(value)) {
                    return this.contains(HighFive.cast(HighFive.unbox(value, T), T));
                }
                return false;
            },
            ...
            System$Collections$ICollection$copyTo: function (array, index) {
                ...
                if (items != null) {
                    ...
                    for (var i = 0; i < count; i = (i + 1) | 0) {
                        objects[System.Array.index(HighFive.identity(index, ((index = (index + 1) | 0))), objects)] = System.Array.getItem(this.list, i, T);
                    }
                }
            },
            GetEnumerator: function () {
                return HighFive.getEnumerator(this.list, T);
            },
            System$Collections$IEnumerable$GetEnumerator: function () {
                return HighFive.getEnumerator(HighFive.cast(this.list, System.Collections.IEnumerable));
            },
            ...
            System$Collections$IList$indexOf: function (value) {
                if (System.Collections.ObjectModel.ReadOnlyCollection$1(T).IsCompatibleObject(value)) {
                    return this.indexOf(HighFive.cast(HighFive.unbox(value, T), T));
                }
                return -1;
            },
