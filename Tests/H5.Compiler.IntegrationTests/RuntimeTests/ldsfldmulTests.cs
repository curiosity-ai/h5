...
{
    [TestClass]
    public class ldsfldmulTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task ldsfldmul_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/unsigned/ldsfld_mul.cs
using System;
