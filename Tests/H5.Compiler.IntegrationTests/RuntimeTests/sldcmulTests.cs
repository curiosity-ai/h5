...
{
    [TestClass]
    public class sldcmulTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task sldcmul_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_ldc_mul.cs
using System;
