...
{
    [TestClass]
    public class muldivTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task muldiv_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/unsigned/muldiv.cs
using System;
