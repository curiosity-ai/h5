...
namespace H5.Contract
{
    public interface IAsyncBlock
    {
        ...
        ICSharpCode.NRefactory.CSharp.AstNode[] AwaitExpressions { get; set; }

        List<ICSharpCode.NRefactory.CSharp.AstNode> WrittenAwaitExpressions { get; set; }
        ...
        bool IsEnumeratorReturn { get; set; }
