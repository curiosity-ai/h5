...
{
    [TestClass]
    public class b369916Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task b369916_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Regression/CLR-x86-JIT/V2.0-RTM/b369916/b369916.cs
using System;
...
public class Program
{
    ...
    {
        try {
            return Test_Main.TestEntryPoint();
        } catch(Exception e) {
