...
{
    [TestClass]
    public class tailjumpTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task tailjump_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Boxing/misc/tailjump.cs
using System;
