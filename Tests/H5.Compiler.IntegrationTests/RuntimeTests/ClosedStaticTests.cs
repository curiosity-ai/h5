...
{
    [TestClass]
    public class ClosedStaticTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task ClosedStatic_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/CoreMangLib/system/delegate/miscellaneous/ClosedStatic.cs
using System;
...
public class Program
{
    ...
    {
        try {
            return ClosedStatic.TestEntryPoint();
        } catch(Exception e) {
