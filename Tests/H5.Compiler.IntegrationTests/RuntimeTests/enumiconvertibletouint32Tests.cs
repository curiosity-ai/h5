...
{
    [TestClass]
    public class enumiconvertibletouint32Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task enumiconvertibletouint32_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/CoreMangLib/system/enum/enumiconvertibletouint32.cs
using System;
...
public class EnumIConvertibleToUint32
{
    ...
    public bool PosTest1()
    {
        ...
        TestFramework.BeginScenario("PosTest1: Convert an enum of zero to Uint32");
    ...
    public bool PosTest3()
    {
        ...
        TestFramework.BeginScenario("PosTest3: Convert an enum of Uint32.maxvalue to Uint32");
    ...
    public bool PosTest4()
    {
        ...
        TestFramework.BeginScenario("PosTest4: Convert an enum of negative zero to Uint32 ");
    ...
    public bool NegTest1()
    {
        ...
        TestFramework.BeginScenario("NegTest1: Convert an enum of negative value to Uint32");
    ...
    public bool NegTest2()
    {
        ...
        TestFramework.BeginScenario("NegTest2: Convert an enum of the value which is bigger than uint32.maxvalue to Uint32");
    ...
    public static int TestEntryPoint()
    {
        ...
        TestFramework.BeginTestCase("EnumIConvertibleToUint32");
...
public class Program
{
    ...
    {
        try {
            return EnumIConvertibleToUint32.TestEntryPoint();
        } catch(Exception e) {
