...
{
    [TestClass]
    public class lcsmaxTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task lcsmax_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Arrays/lcs/lcsmax.cs
using System;
