...
{
    [TestClass]
    public class b392262Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task b392262_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Regression/CLR-x86-JIT/dev10/b392262/b392262.cs
using System;
