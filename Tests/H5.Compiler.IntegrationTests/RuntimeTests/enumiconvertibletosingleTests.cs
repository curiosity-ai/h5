...
{
    [TestClass]
    public class enumiconvertibletosingleTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task enumiconvertibletosingle_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/CoreMangLib/system/enum/enumiconvertibletosingle.cs
using System;
...
public class EnumIConvertibleToSingle
{
    ...
    public bool PosTest1()
    {
        ...
        TestFramework.BeginScenario("PosTest1: Convert zero to single");
    ...
    public bool PosTest2()
    {
        ...
        TestFramework.BeginScenario("PosTest2: Test a normal enum of value 3 ");
    ...
    public bool PosTest3()
    {
        ...
        TestFramework.BeginScenario("PosTest3: Convert an int32 to single");
    ...
    public bool PosTest4()
    {
        ...
        TestFramework.BeginScenario("PosTest4: Convert an int64.MinValue to single");
    ...
    public bool PosTest5()
    {
        ...
        TestFramework.BeginScenario("PosTest5: Convert a negative to single");
    ...
    public bool PosTest6()
    {
        ...
        TestFramework.BeginScenario("PosTest6: Convert a negative zero to single");
    ...
    public static int TestEntryPoint()
    {
        ...
        TestFramework.BeginTestCase("EnumIConvertibleToSingle");
...
public class Program
{
    ...
    {
        try {
            return EnumIConvertibleToSingle.TestEntryPoint();
        } catch(Exception e) {
