...
{
    [TestClass]
    public class lcsvalboxTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task lcsvalbox_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Arrays/lcs/lcsvalbox.cs
using System;
