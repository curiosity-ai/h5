...
{
    [TestClass]
    public class sldsfldmulovfTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task sldsfldmulovf_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_ldsfld_mulovf.cs
using System;
