    HighFive.define("System.Collections.Generic.HashSet$1.ElementCount", function (T) { return {
        $kind: "nested struct",
        statics: {
            methods: {
        ...
        methods: {
            ...
            equals: function (o) {
                if (!HighFive.is(o, System.Collections.Generic.HashSet$1.ElementCount(T))) {
                    return false;
                }
