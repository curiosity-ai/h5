    H5.define("H5.Console", {
        ...
        methods: {
            init: function (reinit) {
                ...
                this.h5Icon = this.h5Icon || document.createElementNS(this.svgNS, "svg");

                var items = H5.fn.bind(this, $asm.$.H5.Console.f4)(new (System.Collections.Generic.Dictionary$2(System.String,System.String)).ctor());

                this.setAttributes(this.h5Icon, items);

                this.h5IconPath = this.h5IconPath || document.createElementNS(this.svgNS, "path");
                ...
                this.setAttributes(this.h5IconPath, items2);

                this.h5ConsoleLabel = this.h5ConsoleLabel || document.createElement("span");
                this.h5ConsoleLabel.innerHTML = "H5 Console";
                ...
                if (!reinit) {
                    this.h5Icon.appendChild(this.h5IconPath);
                    ...
                    this.consoleHeader.appendChild(this.h5Icon);
                    this.consoleHeader.appendChild(this.h5ConsoleLabel);
