...
{
    [TestClass]
    public class lcslongTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task lcslong_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/arrays/lcs_long.cs
using System;
