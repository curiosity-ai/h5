...
{
    [TestClass]
    public class sldcmulovfTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task sldcmulovf_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_ldc_mulovf.cs
using System;
