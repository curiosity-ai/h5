...
{
    [TestClass]
    public class Co6010DelegateEqualsTwoTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task Co6010DelegateEqualsTwo()
        {
            var code = """
// Original: https://github.com/dotnet/runtime/blob/main/src/tests/CoreMangLib/system/delegate/miscellaneous/co6010delegateequalstwo.cs
...
public class Program
{
    ...
    {
        Co6010DelegateEqualsTwo.TestEntryPoint();
    }
}
