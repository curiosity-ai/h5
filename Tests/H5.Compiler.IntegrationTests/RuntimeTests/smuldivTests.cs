...
{
    [TestClass]
    public class smuldivTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task smuldiv_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_muldiv.cs
using System;
