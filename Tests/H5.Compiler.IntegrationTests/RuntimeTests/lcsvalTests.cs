...
{
    [TestClass]
    public class lcsvalTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task lcsval_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Arrays/lcs/lcsval.cs
using System;
