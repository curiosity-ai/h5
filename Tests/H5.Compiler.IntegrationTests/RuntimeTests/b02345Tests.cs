...
{
    [TestClass]
    public class b02345Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task b02345_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Regression/CLR-x86-JIT/V1.2-M01/b02345/b02345.cs
using System;
