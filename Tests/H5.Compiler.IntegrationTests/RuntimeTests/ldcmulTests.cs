...
{
    [TestClass]
    public class ldcmulTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task ldcmul_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/unsigned/ldc_mul.cs
using System;
