...
namespace H5.Contract
{
    public static partial class Helpers
    {
        ...
        {
            return method.Attributes.Any(a => a.AttributeType.FullName == CS.NS.HIGHFIVE + ".ScriptAttribute");
        }

        public static bool IsScript(MethodDefinition method)
        {
            return method.CustomAttributes.Any(a => a.AttributeType.FullName == CS.NS.HIGHFIVE + ".ScriptAttribute");
        }
