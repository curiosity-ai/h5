...
namespace System.Linq.Expressions
{
    ...
    public abstract class Expression
    {
        ...
        [HighFive.Template("{ ntype: 46, t: {right}.t, left: {left}, right: {right} }")]
        ...
        [HighFive.Template("{ ntype: 13, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression Equal(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 13, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 35, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression NotEqual(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 35, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 15, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression GreaterThan(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 15, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 20, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression LessThan(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 20, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 16, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression GreaterThanOrEqual(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 16, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 21, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression LessThanOrEqual(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 21, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 3, t: {type}, left: {left}, right: {right} }")]
        ...
        [HighFive.Template("{ ntype: 37, t: {type}, left: {left}, right: {right} }")]
        ...
        [HighFive.Template("{ ntype: 7, t: {type}, left: {left}, right: {right} }")]
        ...
        [HighFive.Template("{ ntype: 74, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression AddAssignChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 74, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 1, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression AddChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 1, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 76, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression SubtractAssignChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 76, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 43, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression SubtractChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 43, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 75, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression MultiplyAssignChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 75, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 27, t: {type}, left: {left}, right: {right} }")]
        public static extern BinaryExpression MultiplyChecked(Expression left, Expression right, Type type);

        [HighFive.Template("{ ntype: 27, t: {method}.rt, left: {left}, right: {right}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 5, t: {type}, left: {array}, right: {index} }")]
        ...
        [HighFive.Template("{ ntype: 6, t: {type}, obj: {array}, method: { t: 8, td: System.Array.type({type}, {indexes:array}.length), n: \"Get\", rt: {type}, p: System.Array.init({indexes:array}.length, System.Int32, {type}, true), def: function () { return System.Array.$get.call(this, arguments); } }, args: HighFive.toList({indexes:array}) }")]
        public static extern MethodCallExpression ArrayIndex(Type type, Expression array, params Expression[] indexes);

        [HighFive.Template("(function (a, b, c) { return { ntype: 6, t: a, obj: b, method: { t: 8, td: System.Array.type({type}, c.Count), n: \"Get\", rt: a, p: System.Array.init(c.Count, System.Int32, {type}, true), def: function () { return System.Array.$get.call(this, arguments); } }, args: c }; })({type}, {array}, HighFive.toList({indexes}))")]
        public static extern MethodCallExpression ArrayIndex(Type type, Expression array, IEnumerable<Expression> indexes);

        [HighFive.Template("{ ntype: 47, t: {expressions:array}[{expressions:array}.length - 1].t, expressions: HighFive.toList({expressions:array}) }")]
        public static extern BlockExpression Block(params Expression[] expressions);

        [HighFive.Template("(function (a) { return { ntype: 47, t: a.getItem(a.Count - 1).t, expressions: a }; })(HighFive.toList({expressions}))")]
        public static extern BlockExpression Block(IEnumerable<Expression> expressions);

        [HighFive.Template("{ ntype: 47, t: {type}, expressions: HighFive.toList({expressions:array}) }")]
        public static extern BlockExpression Block(Type type, params Expression[] expressions);

        [HighFive.Template("{ ntype: 47, t: {type}, expressions: HighFive.toList({expressions}) }")]
        public static extern BlockExpression Block(Type type, IEnumerable<Expression> expressions);

        [HighFive.Template("{ ntype: 47, t: {expressions:array}[{expressions:array}.length - 1].t, variables: HighFive.toList({variables}), expressions: HighFive.toList({expressions:array}) }")]
        public static extern BlockExpression Block(IEnumerable<ParameterExpression> variables, params Expression[] expressions);

        [HighFive.Template("(function (a, b) { return { ntype: 47, t: b.getItem(b.Count - 1).t, variables: a, expressions: b }; })(HighFive.toList({variables}), HighFive.toList({expressions}))")]
        public static extern BlockExpression Block(IEnumerable<ParameterExpression> variables, IEnumerable<Expression> expressions);

        [HighFive.Template("{ ntype: 47, t: {type}, variables: HighFive.toList({variables}), expressions: HighFive.toList({expressions:array}) }")]
        ...
        [HighFive.Template("{ ntype: 47, t: {type}, variables: HighFive.toList({variables}), expressions: HighFive.toList({expressions}) }")]
        ...
        [HighFive.Template("{ ntype: 8, t: {type}, test: {test}, ifTrue: {ifTrue}, ifFalse: {ifFalse} }")]
        public static extern ConditionalExpression Condition(Expression test, Expression ifTrue, Expression ifFalse, Type type);

        [HighFive.Template("{ ntype: 8, t: System.Object, test: {test}, ifTrue: {ifTrue}, ifFalse: { ntype: 51, t: System.Object } }")]
        public static extern ConditionalExpression IfThen(Expression test, Expression ifTrue);

        [HighFive.Template("{ ntype: 8, t: System.Object, test: {test}, ifTrue: {ifTrue}, ifFalse: {ifFalse} }")]
        ...
        [HighFive.Template("{ ntype: 50, t: System.Object, dtype: 0, expression: {expression}, member: {member} }")]
        public static extern DynamicMemberExpression DynamicMember(Expression expression, string member);

        [HighFive.Template("{ ntype: 50, t: {type}, dtype: 0, expression: {expression}, member: {member} }")]
        public static extern DynamicMemberExpression DynamicMember(Type type, Expression expression, string member);

        [HighFive.Template("{ ntype: 50, t: System.Object, dtype: 1, expression: {expression}, arguments: HighFive.toList({arguments:array}) }")]
        public static extern DynamicInvocationExpression DynamicInvocation(Expression expression, params Expression[] arguments);

        [HighFive.Template("{ ntype: 50, t: System.Object, dtype: 1, expression: {expression}, arguments: HighFive.toList({arguments}) }")]
        ...
        [HighFive.Template("{ ntype: 50, t: {type}, dtype: 1, expression: {expression}, arguments: HighFive.toList({arguments:array}) }")]
        ...
        [HighFive.Template("{ ntype: 50, t: {type}, dtype: 1, expression: {expression}, arguments: HighFive.toList({arguments}) }")]
        ...
        [HighFive.Template("{ ntype: 55, t: {type}, obj: {array}, arguments: HighFive.toList({indexes:array}) }")]
        public static extern IndexExpression ArrayAccess(Type type, Expression array, params Expression[] indexes);

        [HighFive.Template("{ ntype: 55, t: {type}, obj: {array}, arguments: HighFive.toList({indexes}) }")]
        ...
        [HighFive.Template("{ ntype: 55, t: {indexer}.rt, obj: {instance}, indexer: {indexer}, arguments: HighFive.toList({arguments:array}) }")]
        public static extern IndexExpression Property(Expression instance, PropertyInfo indexer, params Expression[] arguments);

        [HighFive.Template("{ ntype: 55, t: {indexer}.rt, obj: {instance}, indexer: {indexer}, arguments: HighFive.toList({arguments}) }")]
        ...
        [HighFive.Template("{ ntype: 22, t: {newExpression}.t, newExpression: {newExpression}, initializers: HighFive.toList({initializers:array}.map(function (i) { return { addMethod: {addMethod}, arguments: HighFive.toList([i]) }; })) }")]
        ...
        [HighFive.Template("{ ntype: 22, t: {newExpression}.t, newExpression: {newExpression}, initializers: HighFive.toList(HighFive.toArray({initializers}).map(function (i) { return { addMethod: {addMethod}, arguments: HighFive.toList([i]) }; })) }")]
        ...
        [HighFive.Template("{ ntype: 22, t: {newExpression}.t, newExpression: {newExpression}, initializers: HighFive.toList({initializers:array}) }")]
        public static extern ListInitExpression ListInit(NewExpression newExpression, params ElementInit[] initializers);

        [HighFive.Template("{ ntype: 22, t: {newExpression}.t, newExpression: {newExpression}, initializers: HighFive.toList({initializers}) }")]
        public static extern ListInitExpression ListInit(NewExpression newExpression, IEnumerable<ElementInit> initializers);

        [HighFive.Template("{ ntype: 58, t: System.Object, body: {body} }")]
        public static extern LoopExpression Loop(Expression body);

        [HighFive.Template("{ ntype: 58, t: {break}.t, body: {body}, breakLabel: {break} }")]
        public static extern LoopExpression Loop(Expression body, LabelTarget @break);

        [HighFive.Template("{ ntype: 58, t: {break} ? {break}.t : System.Object, body: {body}, breakLabel: {break}, continueLabel: {continue} }")]
        public static extern LoopExpression Loop(Expression body, LabelTarget @break, LabelTarget @continue);

        [HighFive.Template("{ btype: 0, member: {member}, expression: {expression} }")]
        ...
        [HighFive.Template("{ ntype: 23, t: {field}.rt, expression: {expression}, member: {field} }")]
        public static extern MemberExpression Field(Expression expression, FieldInfo field);

        [HighFive.Template("{ ntype: 23, t: HighFive.Reflection.getMembers({expression}.t, 4, 284, {fieldName}).rt, expression: {expression}, member: HighFive.Reflection.getMembers({expression}.t, 4, 284, {fieldName}) }")]
        public static extern MemberExpression Field(Expression expression, string fieldName);

        [HighFive.Template("{ ntype: 23, t: {type}, expression: {expression}, member: HighFive.Reflection.getMembers({expression}.t, 4, 284, {fieldName}) }")]
        public static extern MemberExpression Field(Expression expression, Type type, string fieldName);

        [HighFive.Template("{ ntype: 23, t: HighFive.Reflection.getMembers({expression}.t, 16, 284, {propertyName}).rt, expression: {expression}, member: HighFive.Reflection.getMembers({expression}.t, 16, 284, {propertyName}) }")]
        public static extern MemberExpression Property(Expression expression, string propertyName);

        [HighFive.Template("{ ntype: 23, t: {type}, expression: {expression}, member: HighFive.Reflection.getMembers({expression}.t, 16, 284, {propertyName}) }")]
        public static extern MemberExpression Property(Expression expression, Type type, string propertyName);

        [HighFive.Template("{ ntype: 23, t: {property}.rt, expression: {expression}, member: {property} }")]
        ...
        [HighFive.Template("{ ntype: 23, t: HighFive.Reflection.getMembers({expression}.t, 20, 284, {propertyOrFieldName}).rt, expression: {expression}, member: HighFive.Reflection.getMembers({expression}.t, 20, 284, {propertyOrFieldName}) }")]
        public static extern MemberExpression PropertyOrField(Expression expression, string propertyOrFieldName);

        [HighFive.Template("{ ntype: 23, t: {member}.rt, expression: {expression}, member: {member} }")]
        public static extern MemberExpression MakeMemberAccess(Expression expression, MemberInfo member);

        [HighFive.Template("{ ntype: 24, t: {newExpression}.t, newExpression: {newExpression}, bindings: HighFive.toList({bindings:array}) }")]
        public static extern MemberInitExpression MemberInit(NewExpression newExpression, params MemberBinding[] bindings);

        [HighFive.Template("{ ntype: 24, t: {newExpression}.t, newExpression: {newExpression}, bindings: HighFive.toList({bindings}) }")]
        public static extern MemberInitExpression MemberInit(NewExpression newExpression, IEnumerable<MemberBinding> bindings);

        [HighFive.Template("{ btype: 2, member: {member}, initializers: HighFive.toList({initializers:array}) }")]
        public static extern MemberListBinding ListBind(MemberInfo member, params ElementInit[] initializers);

        [HighFive.Template("{ btype: 2, member: {member}, initializers: HighFive.toList({initializers}) }")]
        ...
        [HighFive.Template("{ btype: 1, member: {member}, bindings: HighFive.toList({bindings:array}) }")]
        public static extern MemberMemberBinding MemberBind(MemberInfo member, params MemberBinding[] bindings);

        [HighFive.Template("{ btype: 1, member: {member}, bindings: HighFive.toList({bindings}) }")]
        ...
        [HighFive.Template("{ ntype: 6, t: {method}.rt, method: {method}, args: HighFive.toList({arguments:array}) }")]
        public static extern MethodCallExpression Call(MethodInfo method, params Expression[] arguments);

        [HighFive.Template("{ ntype: 6, t: {method}.rt, method: {method}, args: HighFive.toList({arguments}) }")]
        public static extern MethodCallExpression Call(MethodInfo method, IEnumerable<Expression> arguments);

        [HighFive.Template("{ ntype: 6, t: {method}.rt, obj: {instance}, method: {method}, args: HighFive.toList({arguments:array}) }")]
        public static extern MethodCallExpression Call(Expression instance, MethodInfo method, params Expression[] arguments);

        [HighFive.Template("{ ntype: 6, t: {method}.rt, obj: {instance}, method: {method}, args: HighFive.toList({arguments}) }")]
        public static extern MethodCallExpression Call(Expression instance, MethodInfo method, IEnumerable<Expression> arguments);

        [HighFive.Template("{ ntype: 32, t: System.Array.type({type}), expressions: HighFive.toList({initializers:array}) }")]
        public static extern NewArrayExpression NewArrayInit(Type type, params Expression[] initializers);

        [HighFive.Template("{ ntype: 32, t: System.Array.type({type}), expressions: HighFive.toList({initializers}) }")]
        public static extern NewArrayExpression NewArrayInit(Type type, IEnumerable<Expression> initializers);

        [HighFive.Template("{ ntype: 33, t: System.Array.type({type}, {bounds:array}.length), expressions: HighFive.toList({bounds:array}) }")]
        public static extern NewArrayExpression NewArrayBounds(Type type, params Expression[] bounds);

        [HighFive.Template("(function (l) { return { ntype: 33, t: System.Array.type({type}, l.Count), expressions: l };})(HighFive.toList({bounds}))")]
        public static extern NewArrayExpression NewArrayBounds(Type type, IEnumerable<Expression> bounds);

        [HighFive.Template("{ ntype: 31, t: {type}, constructor: HighFive.Reflection.getMembers({type}, 1, 284, null, []), arguments: HighFive.toList([]) }")]
        public static extern NewExpression New(Type type);

        [HighFive.Template("{ ntype: 31, t: {constructor}.td, constructor: {constructor}, arguments: HighFive.toList({arguments:array}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, params Expression[] arguments);

        [HighFive.Template("{ ntype: 31, t: {constructor}.td, constructor: {constructor}, arguments: HighFive.toList({arguments}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, IEnumerable<Expression> arguments);

        [HighFive.Template("{ ntype: 31, t: {constructor}.td, constructor: {constructor}, arguments: HighFive.toList({arguments}), m: HighFive.toList({members:array}) }")]
        public static extern NewExpression New(ConstructorInfo constructor, Expression[] arguments, params MemberInfo[] members);

        [HighFive.Template("{ ntype: 31, t: {constructor}.td, constructor: {constructor}, arguments: HighFive.toList({arguments}), m: HighFive.toList({members}) }")]
        ...
        [HighFive.Template("{ ntype: 38, t: {type} }")]
        public static extern ParameterExpression Parameter(Type type);

        [HighFive.Template("{ ntype: 38, t: {type}, n: {name} }")]
        ...
        [HighFive.Template("{ body: {body}, testValues: HighFive.toList({testValues:array}) }")]
        public static extern SwitchCase SwitchCase(Expression body, params Expression[] testValues);

        [HighFive.Template("{ body: {body}, testValues: HighFive.toList({testValues}) }")]
        public static extern SwitchCase SwitchCase(Expression body, IEnumerable<Expression> testValues);

        [HighFive.Template("{ ntype: 59, t: {cases:array}[0].body.t, switchValue: {switchValue}, cases: HighFive.toList({cases:array}) }")]
        public static extern SwitchExpression Switch(Expression switchValue, params SwitchCase[] cases);

        [HighFive.Template("{ ntype: 59, t: {cases:array}[0].body.t, switchValue: {switchValue}, defaultBody: {defaultBody}, cases: HighFive.toList({cases:array}) }")]
        public static extern SwitchExpression Switch(Expression switchValue, Expression defaultBody, params SwitchCase[] cases);

        [HighFive.Template("{ ntype: 59, t: {cases:array}[0].body.t, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: HighFive.toList({cases:array}) }")]
        ...
        [HighFive.Template("{ ntype: 59, t: {type}, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: HighFive.toList({cases:array}) }")]
        ...
        [HighFive.Template("(function (a, b, c, d) { return { ntype: 59, t: d.getItem(0).body.t, switchValue: a, defaultBody: b, comparison: c, cases: d }; })({switchValue}, {defaultBody}, {comparison}, HighFive.toList({cases}))")]
        ...
        [HighFive.Template("{ ntype: 59, t: {type}, switchValue: {switchValue}, defaultBody: {defaultBody}, comparison: {comparison}, cases: HighFive.toList({cases}) }")]
        ...
        [HighFive.Template("{ ntype: 61, t: {body}.t, body: {body}, handlers: HighFive.toList([]), fault: {fault} }")]
        public static extern TryExpression TryFault(Expression body, Expression fault);

        [HighFive.Template("{ ntype: 61, t: {body}.t, body: {body}, handlers: HighFive.toList([]), finallyExpr: {finally} }")]
        public static extern TryExpression TryFinally(Expression body, Expression @finally);

        [HighFive.Template("{ ntype: 61, t: {body}.t, body: {body}, handlers: HighFive.toList({handlers:array}) }")]
        public static extern TryExpression TryCatch(Expression body, params CatchBlock[] handlers);

        [HighFive.Template("{ ntype: 61, t: {body}.t, body: {body}, finallyExpr: {finally}, handlers: HighFive.toList({handlers:array}) }")]
        public static extern TryExpression TryCatchFinally(Expression body, Expression @finally, params CatchBlock[] handlers);

        [HighFive.Template("{ ntype: 61, t: {type} || {body}.t, body: {body}, finallyExpr: {finally}, fault: {fault}, handlers: HighFive.toList({handlers} || []) }")]
        ...
        [HighFive.Template("{ ntype: 45, t: System.Boolean, expression: {expression}, typeOperand: {type} }")]
        public static extern TypeBinaryExpression TypeIs(Expression expression, Type type);

        [HighFive.Template("{ ntype: 81, t: System.Boolean, expression: {expression}, typeOperand: {type} }")]
        public static extern TypeBinaryExpression TypeEqual(Expression expression, Type type);

        [HighFive.Template("{ ntype: {unaryType}, t: {type}, operand: {operand} }")]
        public static extern UnaryExpression MakeUnary(ExpressionType unaryType, Expression operand, Type type);

        [HighFive.Template("{ ntype: {unaryType}, t: {type} || {method}.rt, operand: {operand}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 28, t: {type}, operand: {expression} }")]
        public static extern UnaryExpression Negate(Expression expression, Type type);

        [HighFive.Template("{ ntype: 28, t: {method}.rt, operand: {expression}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 29, t: {type}, operand: {expression} }")]
        public static extern UnaryExpression UnaryPlus(Expression expression, Type type);

        [HighFive.Template("{ ntype: 29, t: {method}.rt, operand: {expression}, method: {method} }")]
        ...
        [HighFive.Template("{ ntype: 30, t: {type}, operand: {expression} }")]
        public static extern UnaryExpression NegateChecked(Expression expression, Type type);

        [HighFive.Template("{ ntype: 30, t: {method}.rt, operand: {expression}, method: {method} }")]
