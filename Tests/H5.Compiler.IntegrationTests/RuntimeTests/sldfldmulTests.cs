...
{
    [TestClass]
    public class sldfldmulTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task sldfldmul_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_ldfld_mul.cs
using System;
