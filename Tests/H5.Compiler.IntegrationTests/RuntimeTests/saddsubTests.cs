...
{
    [TestClass]
    public class saddsubTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task saddsub_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/int64/signed/s_addsub.cs
using System;
