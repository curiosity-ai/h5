...
namespace Retyped
{
  ...
  public static class es5
  {
    ...
    public class PromiseLike<T>
    {
      ...
      public extern es5.Promise<Retyped.Primitive.Void> then(Action<T> onfulfilled);
    ...
    public class Promise<T>
    {
      ...
      [Name("catch")]
      public extern es5.Promise<Union<T, Retyped.Primitive.Void>> @catch(
    ...
    public abstract class ClassDecorator : IObject
    {
      ...
      public extern Union<TFunction, Retyped.Primitive.Void> Invoke<TFunction>(
        TFunction target);
    }

    public delegate void PropertyDecorator(Retyped.Primitive.Object target, Union<string, symbol> propertyKey);

    public abstract class MethodDecorator : IObject
    {
      [Template("{this}({0}, {1}, {2})")]
      public extern Union<es5.TypedPropertyDescriptor<T>, Retyped.Primitive.Void> Invoke<T>(
        Retyped.Primitive.Object target,
    ...
    [IgnoreGeneric(AllowInTypeScript = true)]
    [ObjectLiteral]
    [Where("K", typeof (Retyped.Primitive.String.Interface), EnableImplicitConversion = true)]
