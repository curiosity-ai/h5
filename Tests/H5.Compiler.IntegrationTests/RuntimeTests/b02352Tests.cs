...
{
    [TestClass]
    public class b02352Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task b02352_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Regression/CLR-x86-JIT/V1-M10/b02352/b02352.cs
using System;
...
public class Program
{
    ...
    {
        try {
            return cb6054ToByte_all.TestEntryPoint();
        } catch(Exception e) {
