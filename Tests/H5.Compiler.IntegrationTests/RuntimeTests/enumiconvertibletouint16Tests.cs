...
{
    [TestClass]
    public class enumiconvertibletouint16Tests : IntegrationTestBase
    {
        [TestMethod]
        public async Task enumiconvertibletouint16_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/CoreMangLib/system/enum/enumiconvertibletouint16.cs
using System;
...
public class EnumIConvertibleToUint16
{
    ...
    public bool PosTest1()
    {
        ...
        TestFramework.BeginScenario("PosTest1: Convert an enum of zero to Uint16");
    ...
    public bool PosTest3()
    {
        ...
        TestFramework.BeginScenario("PosTest3: Convert an enum of Uint16.maxvalue to uint16");
    ...
    public bool PosTest4()
    {
        ...
        TestFramework.BeginScenario("PosTest4: Convert an enum of negative zero to Uint16 ");
    ...
    public bool NegTest1()
    {
        ...
        TestFramework.BeginScenario("NegTest1: Convert an enum of negative value to Uint16");
    ...
    public bool NegTest2()
    {
        ...
        TestFramework.BeginScenario("NegTest2: Convert an enum of the value which is bigger than uint16.maxvalue to Uint16");
        ...
        try
        {
            ...
            IConvertible i1 = e1 as IConvertible;
            UInt16 u1 = i1.ToUInt16(null);
            TestFramework.LogError("103", "The OverflowException was not thrown as expected");
            retVal = false;
        }
        catch (OverflowException)
        {
        ...
        {
            TestFramework.LogError("104", "Unexpected exception: " + e);
    ...
    public static int TestEntryPoint()
    {
        ...
        TestFramework.BeginTestCase("EnumIConvertibleToUint16");
...
public class Program
{
    ...
    {
        try {
            return EnumIConvertibleToUint16.TestEntryPoint();
        } catch(Exception e) {
