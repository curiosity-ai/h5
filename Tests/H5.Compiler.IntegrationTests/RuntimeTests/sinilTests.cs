...
{
    [TestClass]
    public class sinilTests : IntegrationTestBase
    {
        [TestMethod]
        public async Task sinil_Run()
        {
            var code = """
// Original: External/dotnet_runtime/src/tests/JIT/Methodical/Boxing/xlang/sin_il.cs
using System;
